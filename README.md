# 개인 프로젝트 기간 8월1~ 8월 9일
<H1>Spring boot + JPA 를 활용한 쇼핑몰 </H1>
<h2>프로젝트 정보</h2>
<div>
 <h4> 개발환경 : Intellij </h4>
  <h4> 프레임워크 : Spring boot( version 3.0.9) </h4>
  <h4>  데이터 베이스 : mssql</h4>
  <h4>  언어 : java (version 17)</h4>
  <h4>  그외 : thyemleaf, javascript,css html</h4>
...
<h2>프로젝트 소감</h2>
<div>스프링 부트와 JPA 의 동작원리를 이해하고 스프링 복습에 도움이 되었다. </div>
